                ...
                <li><a href="logout.php" class="button fit">Log Out</a></li>
  				...
  				<!-- Banner -->
  					<section id="banner" data-video="images/banner0">
  						...
  						<video src="images/banner0.mp4" muted autoplay loop playsinline></video>
  					</section>
...
Working with over 900 companies in 160 countries, we can find the right car in the right place, at the right price.</p>
                      <ul class="actions special">
                        <li><a href="rentCar.php" class="button primary large">Rent</a></li>
  									...
  									-->
  									<span class="image"><img src="images/car2.jpg" alt="" /></span>
  								</div>
  							</section>
                      ...
                      <ul class="actions special">
                        <li><a href="rentMotorcycle.php" class="button primary large">Rent</a></li>
  									...
  									<!--
  										...
  										320x340 or at least the same aspect ratio (16:17).
  									-->
  									<span class="image"><img src="images/m3.jpg" alt="" /></span>
  								</div>
  							</section>
                      ...
                      <ul class="actions special">
                        <li><a href="rentTank.php" class="button primary large">Rent</a></li>
  									...
  									<!--
  										...
  										320x340 or at least the same aspect ratio (16:17).
  									-->
  									<span class="image"><img src="images/t2.png" alt="" /></span>
  								</div>
  							</section>
